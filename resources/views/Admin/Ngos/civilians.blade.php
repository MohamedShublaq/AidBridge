    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 text-gray-800">Civilians affiliated with {{ $ngo->name }}</h1>
            </div>
        ...
        <div id="civiliansList">
            @include('Admin.Ngos.listCivilians', compact('civilians'))
        </div>
...
$(document).ready(function () {
    ...
    $('#searchForm').on('input change', function () {
        fetchCivilians('{{ route('admin.ngos.showCivilians' , $ngo->id) }}');
    });
