        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 text-gray-800">Aids Management</h1>
                    <a class="btn btn-primary" href="{{ route('ngo.aids.create') }}">
                        <i class="fas fa-plus-circle"></i> Create New Aid
                    </a>
                </div>
                ...
                <!-- Aids List -->
                <div id="aidsList">
                    @include('Ngo.Aids.list', compact('aids'))
                </div>
...
$(document).ready(function () {
    ...
    $('#searchForm').on('input change', function () {
        fetchAids('{{ route('ngo.aids.index') }}');
    });
