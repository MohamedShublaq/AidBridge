        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 text-gray-800">Deleted Civilians Management</h1>
                </div>
                <!-- Search Form -->
                <div class="card-body">
                    <form id="searchForm">
                ...
                <div id="civiliansList">
                    @include('Ngo.Civilians.listTrashed', compact('civilians'))
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#searchForm').on('input change', function() {
                fetchCivilians('{{ route('ngo.civilians.showTrashed') }}');
            });
