...
class CountrySeeder extends Seeder
{
    private array $countries = [
        ...
        ['iso_code' => 'CD', 'name' => 'Congo, Democratic Republic of the'],
        ...
        ['iso_code' => 'MD', 'name' => 'Moldova, Republic of'],
        ...
        ['iso_code' => 'TW', 'name' => 'Taiwan, Province of China'],
        ['iso_code' => 'TJ', 'name' => 'Tajikistan'],
        ['iso_code' => 'TZ', 'name' => 'Tanzania, United Republic of'],
        ...
        ['iso_code' => 'VE', 'name' => 'Venezuela, Bolivarian Republic of'],
